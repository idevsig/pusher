...
class Pushbullet extends \Pusher\Channel
{
    private string $uri_template = '%s/v2/pushes';

    protected string $default_url = 'https://api.pushbullet.com';
